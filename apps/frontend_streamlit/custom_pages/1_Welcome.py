...
_ASSET_DATA_DIR = Path(__file__).resolve().parents[1] / "assets" / "data"
_logo_b64 = _b64_file(_ASSET_DATA_DIR / "newlogo.png")
_hero_b64 = _b64_file(_ASSET_DATA_DIR / "bf_hero.png")
