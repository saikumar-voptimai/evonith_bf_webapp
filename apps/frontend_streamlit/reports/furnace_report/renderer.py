...
from apps.frontend_streamlit.reports.furnace_report.data import ParamStats, ShiftReportData, TempRow
    ...
    sections = (
        ...
        ReportSection.from_rows(
            ...
            [
                ...
                ["Skin flow", *_temp_cells(r.skin_flow)],
...
def _normalize_shift_markdown_tables(
    ...
    from apps.frontend_streamlit.reports.rendering import split_markdown_blocks
