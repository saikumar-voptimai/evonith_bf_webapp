"""LangChain RAG (Retrieval-Augmented Generation) utilities.

Provides document loading, Chroma vector store management, and retrieval-chain
construction for the legacy LangChain-based Copilot RAG pipeline.  These
helpers are retained as a fallback and for experimentation; the primary
Knowledge Hub path uses :class:`~memory.knowledge_vector_store.KnowledgeVectorStore`
with Qdrant instead.
"""
