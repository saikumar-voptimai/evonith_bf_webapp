...
from furnace_data.bmo.utils.types import ModelPrediction
...
def _resolve_repo_path(path_str: str) -> Path:
    ...
    Args:
         - path_str: str - Absolute or repository-relative path from configurationuration.
...
class FuelUnitCostModelService:
    ...
    def build_prebuilt_context(
        ...
        *,
        ...
        from furnace_data.bmo.utils.feature_builder import build_prebuilt_feature_context
