...
from furnace_data.bmo.utils.calculations import compute_dry_weight_mt, compute_fe_contribution_mt
from furnace_data.bmo.utils.types import OreInput
...
# furnace_data/assets/config/setting_ds_dv.yml::field_mapping and is consumed by the Data
