...
| `alembic/versions/20260427_0001_create_relational_tables.py` | Migration creates older unqualified tables and does not match current ORM schemas | Documented mismatch; no destructive migration added in Phase 5 |
| `alembic/env.py` | Uses `furnace_data.relational.models.Base` metadata | No change |
