...
from domain.optimization_runtime import FeatureVectorBuilder, ModelBundleInfo, ModelBundleService
...
def test_bmo_objective_evaluator_runs_with_fallback_model():
    ores = [
        OreInput(
            ...
            min_share_pct=50.0,
            max_share_pct=80.0,
            chemistry=OreChemistry(fe_t_pct=55.0, feo_pct=8.0, sio2_pct=5.0, al2o3_pct=2.0),
        ),
        OreInput(
            ore_id="ore_a",
            display_name="ORE A",
            ...
            min_share_pct=20.0,
            max_share_pct=50.0,
            chemistry=OreChemistry(fe_t_pct=62.0, feo_pct=0.5, sio2_pct=4.0, al2o3_pct=1.8),
        ),
    ]
