"""Shared material-name mapping for plant-admin workflows."""
...
class MaterialNameMapper:
    """Map display names to canonical plant-master material names."""
    ...
    @classmethod
    def from_file(cls, path: str | Path | None = None) -> "MaterialNameMapper":
        config_path = Path(path) if path is not None else get_config_path("materials_map.yml")
