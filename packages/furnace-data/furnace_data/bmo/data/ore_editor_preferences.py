...
_PACKAGED_OPERATOR_INPUTS_PATH = get_config_path("bmo_operator_inputs.yml")
...
def load_ore_editor_preferences(path: str | Path) -> dict[str, Any]:
    ...
    pref_path = Path(path)
    if not pref_path.exists() and pref_path.name == _PACKAGED_OPERATOR_INPUTS_PATH.name:
        pref_path = _PACKAGED_OPERATOR_INPUTS_PATH
