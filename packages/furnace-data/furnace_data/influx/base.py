        ...
        Args:
            recent_data_of: One of the preset keys in :data:`TIMEDELTAS`
                ...
                *start_time* and *end_time*), or ``"live"`` (raises
                :class:`NotImplementedError` Ã¢â‚¬â€ subclass override needed).
            ...
            selected_fields: Optional subset generated by server-side
                allowlist logic. Unknown fields are rejected before query
                construction.
