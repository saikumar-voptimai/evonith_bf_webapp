...
chosen mapping is persisted to the active ``material_balance.yml`` and
...
def _yml_path() -> Path:
    """Resolve the active material_balance.yml path."""
    return get_config_path(_YML_FILENAME)
...
def discover_dpr_fields(day: date) -> List[str]:
    ...
    """
    from furnace_data.material_balance.data_sources import fetch_dpr_for_day
