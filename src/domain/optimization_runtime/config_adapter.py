...
def build_runtime_config(
    ...
    *,
    ...
    dataset.setdefault("static_dataset_path", data_sources.get("static_dataset_path") or cfg.get("DATA") or default_dataset_path)
    dataset.setdefault("refresh_enabled", bool(dataset.get("refresh_enabled", False)))
    dataset.setdefault("refresh_rm_choice", str(dataset.get("refresh_rm_choice", "RM Charge")))
